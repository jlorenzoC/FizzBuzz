...
describe('FizzBuzz tests', () => {
  ...
  it('Should exist div with text FizzBuzz', () => {
    cy.get('div.p-card-title').contains('FizzBuzz').should('exist');
  });
  it('Should exist div with text Which number is Fizz, Buzz, or FizzBuzz?', () => {
    cy.get('div.p-card-subtitle').contains('FizzBuzz').should('exist');
  });
  ...
  it('Should exist card with the number 1 as title', () => {
    ...
    cy.get('p-card.fizzbuzz-card').should('have.length', 20);
